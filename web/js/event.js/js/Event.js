...
/*:
	...
	eventjs.add(window, "drag", function(event, self) {
		if (LOG) console.log(self.gesture, self.state, self.start, self.x, self.y, self.bbox);
	});
*/
...
/*:
	...
	----------------------------------------------------
	eventjs.add(window, "gesture", function(event, self) {
		if (LOG) console.log(self.rotation, self.scale, self.fingers, self.state);
	});
*/
...
/*:
	...
	eventjs.add(window, "devicemotion", function(event, self) {
		if (LOG) console.log(self.acceleration, self.accelerationIncludingGravity);
	});
*/
...
/*:
	...
	eventjs.add(window, "swipe", function(event, self) {
		if (LOG) console.log(self.velocity, self.angle);
	});
*/
...
/*:
	...
	eventjs.add(window, "tap", function(event, self) {
		if (LOG) console.log(self.fingers);
	});
	----------------------------------------------------
...
/*:
	...
	eventjs.add(window, "wheel", function(event, self) {
		if (LOG) console.log(self.state, self.wheelDelta);
	});
*/
