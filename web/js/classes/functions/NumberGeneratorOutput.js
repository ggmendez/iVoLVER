var NumberGeneratorOutput = fabric.util.createClass(fabric.Path, {
    ...
    setValue: function (numericValue, refreshCanvas, shouldAnimate) {
        ...
        console.log("%c NumberGeneratorOutput setValue function. shouldAnimate: " + shouldAnimate + ", refreshCanvas: " + refreshCanvas, "background: #4B0082; color: white;");
            ...
            'moving': function (options) {
                ...
                if (theOutputPoint.connecting) {
                    ...
                    if (theGenerator) {
                        ...
                        var startingX = theGenerator.minX.getCenterPoint().x - theOutputPoint.width * theOutputPoint.scaleX / 2;
                        var endingX = theGenerator.maxX.getCenterPoint().x + theOutputPoint.width * theOutputPoint.scaleX / 2;
                        ...
                        if (left < startingX) {
                            ...
                            theOutputPoint.setPositionByOrigin(new fabric.Point(theGenerator.minX.getCenterPoint().x, theOutputPoint.top), 'center', 'center');

                        } else if (right > endingX) {

                            theOutputPoint.lockMovementX = true;
                            theOutputPoint.setPositionByOrigin(new fabric.Point(theGenerator.maxX.getCenterPoint().x, theOutputPoint.top), 'center', 'center');
